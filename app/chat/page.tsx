...
import { Loader2, Send, Plus, MessageSquare, Trash2, PanelLeftClose, PanelLeft, Pencil, User, Bot } from "lucide-react";
      ...
      <div className="flex-1 flex overflow-hidden brut-card bg-white p-0 relative">
                ...
                chats.map((chat) => (
                  <div
                    ...
                    className={`
                      ...
                      ${activeChatId === chat.id ? "bg-indigo-600 text-white shadow-[2px_2px_0px_0px_black] -translate-x-[2px] -translate-y-[2px]" : "bg-white hover:bg-indigo-50"}
                    `}
                  >
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-[#F5F5F5] relative">
          ...
          <div className="sm:hidden p-4 border-b-4 border-black bg-white flex items-center justify-between">
            <h2 className="font-black uppercase text-xs truncate max-w-[200px]">{activeTitle}</h2>
          </div>
                ...
                {messages.map((msg) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      {msg.role === "assistant" && (
                        <div className="w-6 h-6 bg-black border border-black flex items-center justify-center rotate-[-3deg]">
                      ...
                      {msg.role === "user" && (
                        <div className="w-6 h-6 bg-indigo-600 border border-black flex items-center justify-center rotate-[3deg]">
          ...
          <div className="p-6 bg-white border-t-4 border-black relative z-10">
            ...
            <form onSubmit={handleSend} className="flex border-4 border-black bg-white shadow-[8px_8px_0px_0px_black] focus-within:translate-x-[2px] focus-within:translate-y-[2px] focus-within:shadow-[4px_4px_0px_0px_black] transition-all">
              <input
                type="text"
                value={input}
